<?php 
    ...
    if (isset($_FILES['file'])) {
      ...
      if ( 0 < $_FILES['file']['error'] ) {
          ...
          move_uploaded_file($_FILES['file']['tmp_name'], '../temp_accounts/' . $first_name . $last_name . $account_num . '/' . $file_name);
    ...
    copy($srcdir . '/' . $file_name, $dstdir . '/' . $file_name);
    ...
    else
    {
        ...
        if ( $result_proj = mysqli_query($conn, $sql) ) {
            ...
            {
                //echo $linkname;
                $addlink = "UPDATE projects SET publish_docs= '$file_name' WHERE owner_email = '$email'";
    ...
    $tmp_file = ("../temp_accounts/". $first_name . $last_name . $account_num . "/" . $project_name . $project_id . ".php");

    $filephpwithlink = "<!DOCTYPE html>
    <html lang=\"en\">
    <head>
    <meta charset=\"utf-8\">
